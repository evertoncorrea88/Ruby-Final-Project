...
class CheckInsControllerTest < ActionController::TestCase
  ...
  test "should create check_in" do
    assert_difference('CheckIn.count') do
      post :create, check_in: { date_in: @check_in.date_in, date_out: @check_in.date_out, guest_id: @check_in.guest_id, host_id: @check_in.host_id }
    end
  ...
  test "should update check_in" do
    patch :update, id: @check_in, check_in: { date_in: @check_in.date_in, date_out: @check_in.date_out, guest_id: @check_in.guest_id, host_id: @check_in.host_id }
    assert_redirected_to check_in_path(assigns(:check_in))
  end
